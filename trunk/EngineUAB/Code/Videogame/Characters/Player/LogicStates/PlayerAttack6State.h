...
#ifndef _PLAYER_ATTACK_6_STATE_H_
#define _PLAYER_ATTACK_6_STATE_H_
...
class CPlayerAttack6State : public CState< CCharacter >
{
public:
	CPlayerAttack6State( CCharacter * _pCharacter, const std::string &_Name );
	~CPlayerAttack6State();
...
#endif //_PLAYER_ATTACK_6_STATE_H_