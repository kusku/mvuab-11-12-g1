...
struct SBloomPostProcessSettings
{
		...
		SBloomPostProcessSettings(float bloomThreshold, float blurAmount,
...
class CBloomPostProcess
{
	private:
		...
		SBloomPostProcessSettings	m_Settings;
	...
	public:
		CBloomPostProcess(const SBloomPostProcessSettings& settings);
		virtual ~CBloomPostProcess();
