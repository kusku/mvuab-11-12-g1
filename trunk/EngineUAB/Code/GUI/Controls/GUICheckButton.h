...
class CGUICheckButton: public CGuiElement
{
...
public:
	CGUICheckButton( uint32 windowsHeight, uint32 windowsWidth, float height_precent, float witdh_percent,
	...
	virtual ~CGUICheckButton() {/*NOTHING*/;}
