#include "GUIPointerMouse.h"
#include "InputManager.h"
#include "Core.h"
#include "Base.h"

//---Constructor
CGUIPointerMouse::CGUIPointerMouse(	uint32 windowsHeight, uint32 windowsWidth, float height_precent, float witdh_percent,
...
void CGUIPointerMouse::Render (CRenderManager *renderManager, CFontManager* fm)
{
...
void CGUIPointerMouse::Update (CInputManager* inputManager, float elapsedTime)
{
...
void CGUIPointerMouse::SetTexture (CTexture* texture, std::string name )
{
