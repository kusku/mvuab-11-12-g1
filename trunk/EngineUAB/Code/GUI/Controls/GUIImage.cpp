...
//---Constructor
CGUIImage::CGUIImage(	uint32 windowsHeight, uint32 windowsWidth, float height_precent, float witdh_percent,
...
void CGUIImage::Render (CRenderManager *renderManager, CFontManager* fm)
{
...
void CGUIImage::Update (CInputManager* intputManager, float elapsedTime)
{
	if (m_bAnimated)
	{
...
//---------------CGUIImage Interface----------------------
void CGUIImage::PlayAnimation (float timePerImage, bool loop)
{
...
void CGUIImage::FadeOut(float startTime, float fadePerSecond)
{
