...
void CGUISlider::Render	(CRenderManager *renderManager, CFontManager* fm)
{
...
void CGUISlider::Update(CInputManager* intputManager, float elapsedTime)
{
...
void CGUISlider::SetOnClickedAction (std::string & inAction )
{
	m_Button.SetOnClickedAction(inAction);
}

void CGUISlider::SetOnOverAction	(std::string & inAction )
{
	m_Button.SetOnOverAction(inAction);
}

void CGUISlider::SetOnChangeValueAction (std::string & inAction)
{
	m_sLuaCode_OnChangeValue = inAction;
}

void CGUISlider::SetButtonTextures	(CTexture* normal, CTexture* over, CTexture* clicked, CTexture* deactivated)
{
	m_Button.SetTextures(normal, over, clicked, deactivated);
}

void CGUISlider::SetBackGroundTexture (CTexture* background)
{
	m_pBackGroundTexture = background;
}

void CGUISlider::SetButtonColors	(const CColor& normal, const CColor& over, const CColor& clicked, const CColor& deactivated, float alpha)
{
	m_Button.SetColors(normal, over, clicked, deactivated, alpha);
}

void CGUISlider::SetBackGroundColor (const CColor& background, float alpha)
{
	m_BackGroundColor	= background;
	m_BackGroundColor.SetAlpha(alpha);
}

void CGUISlider::OnChangeValue( void )
{
