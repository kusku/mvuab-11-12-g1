...
class 'CCombatZone4Trigger' (CBoxTrigger)
	...
	function CCombatZone4Trigger:on_enter(user_data)
	...
	function CCombatZone4Trigger:on_stay(user_data)
	end
	
	function CCombatZone4Trigger:on_exit(user_data)
	end
	
	function CCombatZone4Trigger:are_enemies_dead()
		local l_previous_enemies_to_die = { "enemy15", "enemy16", "enemy31", "enemy32", "enemy33" }
		local l_total_enemies_to_die = 5
