...
function get_draw_calls()
	...
	core:get_debug_options():set_int(value)
end
...
function get_vertices_in_scene()
	local value = core:get_stadistics():get_vertices_in_scene()
	core:get_debug_options():set_int(value)
end

function get_vertices_in_frustum()
