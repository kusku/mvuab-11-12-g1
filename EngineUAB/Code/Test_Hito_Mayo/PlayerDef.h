...
#define ACTION_MOVE_PLAYER_FOWARD			"MoveCameraFoward"
#define ACTION_MOVE_PLAYER_BACK				"MoveCameraBack"
#define ACTION_MOVE_PLAYER_LEFT				"MoveCameraLeft"
#define ACTION_MOVE_PLAYER_RIGHT			"MoveCameraRight"

#define MOMENTUM							15.f		// Cantidad de movimiento del player
