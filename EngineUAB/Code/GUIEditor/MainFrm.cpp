...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndElementView.AttachToTabWnd(&m_wndFileView, DM_SHOW, TRUE, &pTabbedBar);
...
BOOL CMainFrame::CreateDockingWindows()
{
	...
	ASSERT(bNameValid);
	if (!m_wndElementView.Create(strClassView, this, CRect(0, 0, 200, 200), TRUE, ID_VIEW_CLASSVIEW, WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CBRS_LEFT | CBRS_FLOAT_MULTI))
	{
...
void CMainFrame::SetDockingWindowIcons(BOOL bHiColorIcons)
{
	...
	m_wndElementView.SetIcon(hClassViewIcon, FALSE);
