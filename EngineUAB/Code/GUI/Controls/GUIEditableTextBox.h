...
class CGUIEditableTextBox: public CGuiElement
{

public:
	CGUIEditableTextBox( uint32 windowsHeight, uint32 windowsWidth, float height_precent, float witdh_percent,
