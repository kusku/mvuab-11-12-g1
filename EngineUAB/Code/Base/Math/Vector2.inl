...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Dot entre dos vectores
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename T>
inline float Vector2<T>::Dot(const Vector2<T>& otro) const
{
	return x*otro.x + y*otro.y;
}
...
template<typename T>
inline Vector2<T> Vector2<T>::GetXYFromAngle (float radians)
{	
	x = sin( radians );
	y = cos( radians );
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename T>
inline Vector2<T>& Vector2<T>::GetPerpendicular()
{
	T Coord = x;
	x = -y;
	y = Coord;
